    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('join_device', models.CharField(default='pc', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_id', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='members.product')),
            ],
            options={
                'verbose_name': '정기결제',
        ...
        migrations.AddIndex(
            model_name='product',
            index=models.Index(fields=['name'], name='product_search_target'),
        ),
        migrations.AddIndex(
            model_name='product',
        ...
        migrations.AddIndex(
            model_name='bankinfo',
            index=models.Index(fields=['title'], name='bank_info_search_target'),
        ),
        migrations.AddIndex(
            model_name='bankinfo',
